...
def draw_crude(level_map, row, column):
    ...
    if str(level_map[row][column])[0] == '5':
        p_one_level_render.blit(color_change_tile,  (column*40, row*40))
        p_two_level_render.blit(color_change_tile,  (column*40, row*40))
        p_three_level_render.blit(color_change_tile, (column*40, row*40))
        p_four_level_render.blit(color_change_tile, (column*40, row*40))
